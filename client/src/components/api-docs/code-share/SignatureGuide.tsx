  ...
  return (
    <section>
      ...
      <p className="text-sm text-white/50 mb-8 leading-relaxed">
        ...
        Use your API Key and Secret to call the signing endpoint for the <code className="text-accent-blue">code-share</code> category.
      </p>
...
// Response
{
  "success": true,
  "data": {
    "signedUrl": "https://yourapp.com/code-share/resource_uuid?signature=...",
