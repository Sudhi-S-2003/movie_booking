...
import { Ticket, BarChart3, LifeBuoy, Settings, MessageCircle, KeyRound, Puzzle, ShieldCheck, Users } from 'lucide-react';
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: Users, label: 'Teams', to: '/user/teams', colorClass: 'text-accent-pink' },
        ],
      },
      {
        label: 'Developer',
